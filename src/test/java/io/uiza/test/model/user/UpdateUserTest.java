...
public class UpdateUserTest extends TestBase {
  ...
  public void testSuccess() throws UizaException {
    ...
    paramsOfUpdate.put("username", "User Name");
    paramsOfUpdate.put("email", "Email");
    paramsOfUpdate.put("password", "Password");
    paramsOfUpdate.put("fullname", "Fullname");
    paramsOfUpdate.put("dob", "dd/MM/yyyy");
    paramsOfUpdate.put("gender", Gender.MALE.getVal());
    paramsOfUpdate.put("isAdmin", Role.ADMIN.getVal());
