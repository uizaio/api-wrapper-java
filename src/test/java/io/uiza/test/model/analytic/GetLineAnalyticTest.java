package io.uiza.test.model.analytic;
...
public class GetLineAnalyticTest extends TestBase {
  ...
  public void setUp() throws Exception {
    ...
    params.put("end_date", "");
    params.put("type", Metric.REBUFFER_FREQUENCY.toString());
  ...
  public void testSuccess() throws UizaException {
    ...
    Mockito.when(ApiResource.request(RequestMethod.GET, TEST_URL, params,
        DescriptionLink.GET_LINE.toString())).thenReturn(expected);
    Mockito.when(ApiResource.checkResponseType(Mockito.any())).thenCallRealMethod();

    JsonArray actual = Analytic.getLine(params);
  ...
  public void testFailedThrowsBadRequestException() throws UizaException {
    ...
    Mockito.when(
        ApiResource.request(RequestMethod.GET, TEST_URL, null, DescriptionLink.GET_LINE.toString()))
        .thenThrow(e);
    expectedException.expect(e.getClass());
    expectedException.expectMessage(e.getMessage());

    Analytic.getLine(null);
  }
  ...
  public void testFailedThrowsServiceUnavailableException() throws UizaException {
    UizaException e = new ServiceUnavailableException(ErrorMessage.SERVICE_UNAVAILABLE_ERROR, "",
        503, DescriptionLink.GET_LINE.toString());
  ...
  public void testFailedThrowsUizaException() throws UizaException {
    UizaException e = new UizaException("", "", 300, DescriptionLink.GET_LINE.toString());
