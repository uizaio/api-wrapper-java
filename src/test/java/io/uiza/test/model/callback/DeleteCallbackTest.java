...
import io.uiza.model.Callback.DescriptionLink;
...
public class DeleteCallbackTest extends TestBase {
  ...
  public void testSuccess() throws UizaException {
    ...
    expected.addProperty("id", CALLBACK_ID);
    ...
    JsonObject actual = Callback.delete(CALLBACK_ID);
  ...
  public void testFailedThrowsBadRequestException() throws UizaException {
    ...
    Callback.delete(CALLBACK_ID);
  }

  @Test
  public void testFailedThrowsUnauthorizedException() throws UizaException {
    UizaException e = new UnauthorizedException(ErrorMessage.UNAUTHORIZED_ERROR, CALLBACK_ID, 401,
        DescriptionLink.DELETE.toString());
  ...
  public void testFailedThrowsNotFoundException() throws UizaException {
    UizaException e = new NotFoundException(ErrorMessage.NOT_FOUND_ERROR, CALLBACK_ID, 404,
        DescriptionLink.DELETE.toString());
  ...
  public void testFailedThrowsUnprocessableException() throws UizaException {
    UizaException e = new UnprocessableException(ErrorMessage.UNPROCESSABLE_ERROR, CALLBACK_ID, 422,
        DescriptionLink.DELETE.toString());
  ...
  public void testFailedThrowsInternalServerException() throws UizaException {
    UizaException e = new InternalServerException(ErrorMessage.INTERNAL_SERVER_ERROR, CALLBACK_ID,
        500, DescriptionLink.DELETE.toString());
  ...
  public void testFailedThrowsServiceUnavailableException() throws UizaException {
    UizaException e = new ServiceUnavailableException(ErrorMessage.SERVICE_UNAVAILABLE_ERROR,
        CALLBACK_ID, 503, DescriptionLink.DELETE.toString());
  ...
  public void testFailedThrowsClientException() throws UizaException {
    UizaException e = new ClientException(ErrorMessage.CLIENT_ERROR, CALLBACK_ID, 450,
        DescriptionLink.DELETE.toString());
  ...
  public void testFailedThrowsServerException() throws UizaException {
    UizaException e = new ServerException(ErrorMessage.SERVER_ERROR, CALLBACK_ID, 550,
        DescriptionLink.DELETE.toString());
  ...
  public void testFailedThrowsUizaException() throws UizaException {
    UizaException e = new UizaException("", CALLBACK_ID, 300, DescriptionLink.DELETE.toString());
